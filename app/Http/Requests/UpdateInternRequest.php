...
class UpdateInternRequest extends FormRequest
{
    ...
    {
        return Intern::rules($this->route('intern')->id ?? $this->route('id'));
    }
    ...
    protected function prepareForValidation(): void
    {
        ...
        // Set default values for fields that might not be in the form
        $defaults = [
            'whatsapp_number' => $this->route('intern')->whatsapp_number,
            'semester' => $this->route('intern')->semester,
            'gpa' => $this->route('intern')->gpa,
            'birth_date' => $this->route('intern')->birth_date,
            'is_active' => $this->route('intern')->is_active ?? true,
        ];

        // Only merge defaults for fields that are not present in the request
